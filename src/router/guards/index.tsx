...
import { useAsyncLayoutEffect, useReactive, useShallowReactive, useUnmount } from '@libs/hooks';
...
import { isReactFC, isReactForwardFC, isReactComponent } from '@libs/common';
...
export function AuthRole<GFC extends ReactComponent>(args: GFC | { children: ReactNode }): GFC | ReactNode {
  ...
  if (isReactComponent(args)) {
    const Component = args as FC<any>;
